...
from tinker_cookbook.rl.rapo import RAPOConfig
...
async def cli_main(cli_config: CLIConfig):
    ...
    config = Config(
        ...
        rapo_config=RAPOConfig(
            alpha_max=cli_config.rapo_alpha_max,
            n_probes=cli_config.rapo_n_probes,
            beta=cli_config.rapo_beta,
        ) if cli_config.rapo else None,
    )
